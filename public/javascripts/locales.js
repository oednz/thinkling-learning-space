...
window.locales.en.translation = 
{
	...
	"error": "Sorry, but something went wrong. Please contact admin@contexteducation.org",
	"welcome": "Welcome",
	...
	"spacedeck_pro_ad_folders": "With Thinkling Pro, you can organize an unlimited amount of Spaces in Folders and manage access controls for each Folder. Would you like to learn more about Pro features?",
	"spacedeck_pro_ad_versions": "With Thinkling Pro, you can save unlimited versions of each Space to track your progress or keep snapshots safe. Would you like to learn more about Pro features?",
	"spacedeck_pro_ad_pdf": "With Thinkling Pro, you can export your Spaces as crisp PDFs for archiving, mailing around, or printing. Do you want to learn more about Pro features?",
	"spacedeck_pro_ad_zip": "With Thinkling Pro, you can export the contents of a Space as a ZIP package. Do you want to learn more about Pro features?",
	"spacedeck_pro_ad_colors": "With Thinkling Pro, you can mix your own colors using a professional color picker.",
	...
	"landing_claim": "Thinkling lets you easily combine all kinds of media on virtual whiteboards: Text notes, photos, web links, even videos and audio recordings. ",
	"landing_example": "People use Thinkling to organize their ideas, in teams to see whole projects at a glance, or in schools and universities for richer, connected learning experiences.",
	"spaces": "My Spaces",
...
window.locales.de.translation = 
{
	...
	"error": "Entschuldigung, etwas ist schiefgegangen. Bitte kontaktiere admin@contexteducation.org",
	"welcome": "Willkommen",
	...
	"title": "Titel",
	"name": "Name",
	"confirm_subject": "E-Mail Bestätigung für Thinkling",
	"confirm_body": "Danke, dass du dich bei Thinkling angemeldet hast.\nBitte klicke auf den folgenden Link, um deine E-Mail Adresse zu bestätigen.\n ",
	"confirm_action": "E-Mail Bestätigen",
	"team_invite_membership_subject": "Einladung zu %s auf Thinkling",
	"team_invite_membership_body": "Du wurdest zu %s auf Thinkling eingeladen. \n Bitte klicke auf den folgenden Link, um die Einladung anzunehmen.",
	"team_invite_user_body": "Du wurdest zu %s auf Thinkling eingeladen. Dein temporäres Passwort ist \"%s\".\n Bitte klicke auf den folgenden Link, um die Einladung anzunehmen.",
	"team_invite_admin_body": " %s wurde zu %s auf Thinkling eingeladen. Das temporäres Passwort ist \"%s\".",
	...
	"spacedeck_pro_ad_folders": "Mit Thinkling Pro kannst du beliebig viele Spaces in Ordnerstrukturen organisieren und für jeden Ordner Zugriffsrechte regeln. Möchtest du mehr über die Pro-Version erfahren?",
	"spacedeck_pro_ad_versions": "Mit Thinkling Pro kannst du beliebig viele Versionen deines Spaces festhalten und später die Entwicklungsgeschichte nachvollziehen. Möchtest du mehr über die Pro-Version erfahren?",
	"spacedeck_pro_ad_pdf": "Mit Thinkling Pro kannst du Spaces und sogar ganze Ordner als druckreife PDFs exportieren oder per Mail versenden. Möchtest du mehr über die Pro-Version erfahren?",
	"spacedeck_pro_ad_zip": "Mit Thinkling Pro kannst du die Inhalte deiner Spaces jederzeit als ZIP-Paket exportieren. Möchtest du mehr über die Pro-Version erfahren?",
	"spacedeck_pro_ad_colors": "Thinkling Pro enthält einen Profi-Farbmischer, mit dem du deine eigenen Farben mischen kannst.",
	...
	"landing_claim": "Mit Thinkling kannst du multimedial auf virtuellen Whiteboards im Internet zusammenarbeiten: Kombiniere Texte, Fotos, Websites oder sogar Videos und Sounds. ",
	"landing_example": "Thinkling ist ideal, um Ideen zu visualisieren, in kreativen Teams Projekte zu überblicken oder um den Unterricht in Schulen und Universitäten interaktiv zu gestalten.",
	"spaces": "Meine Spaces",
	"access_editor_link": "Sofort-Mitmachen-Link",
	"access_editor_link_desc": "Mit diesem Link kann man sogar ohne Thinkling-Account sofort mitarbeiten. Praktisch!",
	...
	"landing_features_text": "Thinkling 5 hat eine brandneue Benutzeroberfläche, die das Arbeiten einfacher und intuitiver und macht - gleichzeitig aber auch mehr mächtige Werkzeuge bereitstellt.",
	...
	"welcome_subject": "Willkommen bei Thinkling",
	"welcome_body": "Danke, dass du dich bei Thinkling angemeldet hast. <br> Wir hoffen, du wirst viel Spaß mit Thinkling haben. <br> Vergiss nicht, dass du mit unbegrenzt vielen Kollegen und Freunden kostenlos zusammen arbeiten kannst. ",
	...
	"password_reset_subject": "Neues Passwort für Thinkling",
	"password_reset_body": "Du möchtest das Passwort für deinen Thinkling Account zurücksetzen?\nBitte klicke dafür auf den folgenden Link:",
	"password_reset_action": "Jetzt Passwort neu setzen",
	"pro_ad_history_headline": "Nach einem Upgrade zu Thinkling Pro kannst du hier einen Überblick über alle aktuellen Aktivitäten in Spaces bekommen.",
...
window.locales.fr.translation = 
{
	...
	"support": "Aide Thinkling",
	"offline": "Désolé , mais les serveurs Thinkling ne peuvent pas être atteint pour le moment. Plus d' informations ici.",
	"error": "Désolé, une erreur s'est produite. Veuillez contacter admin@contexteducation.org",
	"welcome": "Bienvenue",
	...
	"ceo": "Gestionnaire",
	"name": "name",
	"confirm_subject": "Confirmation de l'email Thinkling",
	"confirm_body": "Merci pour votre inscription à Thinkling.\nSil vous plaît cliquez sur le lien suivant pour confirmer votre adresse e-mail.",
	"confirm_action": "Confirmer",
	"team_invite_membership_subject": "Team Invitation for %s",
	"team_invite_membership_body": "You have been invited to %s on Thinkling.\nPlease click on the following link to accept the invitation.",
	"team_invite_user_body": "You have been invited to %s on Thinkling.\nYour temporary password is \"%s\".\nPlease click on the following link to accept the invitation.",
	"team_invite_admin_body": "%s was invited for your team: %s. The temporary password is \"%s\".",
	"team_invite_membership_acction": "Accept",
	...
	"spacedeck_pro_ad_folders": "Avec Thinkling Pro, vous pouvez organiser un nombre illimité de espaces dans les dossiers et gérer les contrôles d'accès pour chaque dossier. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"spacedeck_pro_ad_versions": "Avec Thinkling Pro, vous pouvez enregistrer des versions illimitées de chaque espace pour suivre vos progrès ou de conserver des instantanés sécurité. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"spacedeck_pro_ad_pdf": "Avec Thinkling Pro, vous pouvez exporter vos espaces et même des dossiers entiers belles PDF pour l'archivage, de diffusion, ou autour de l'impression. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"spacedeck_pro_ad_zip": "Avec Thinkling Pro, vous pouvez exporter le contenu d'un espace comme un paquet ZIP. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"spacedeck_pro_ad_colors": "Avec Thinkling Pro, vous pouvez mélanger vos propres couleurs en utilisant un sélecteur de couleur professionnelle.",
	"profile_caption": "Profil",
	...
	"landing_example": "Que vous soyez étudiant, enseignant ou chercheur: Avec Thinkling il est facile pour vous de créer, de gérer et de partager des cours ou le travail en classe. Développez vos théories visuellement. Organisez des notes de recherche, web, images, audio et vidéo.",
	"spaces": "Espaces",
	"access_editor_link": "Lien instantané.",
	"access_editor_link_desc": "Donnez ce lien à tous ceux que vous voulez inviter rapidement. Ils n’ont pas besoin créer un compte Thinkling.",
	...
	"landing_features_text": "Le tout nouveau Thinkling 5 vous permet de travailler bien plus facilement grâce à sa magnifique interface simplifiée.",
	...
	"password_reset_subject": "Réinitialiser le Mot de passe pour Thinkling",
